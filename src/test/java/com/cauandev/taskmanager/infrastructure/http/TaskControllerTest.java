...
class TaskControllerTest {
    ...
    void should_save_and_retrieve_task_by_id() throws Exception {
        ...
        taskRequest.put("title", "Aprender Spring Rest Docs");
        taskRequest.put("description", "Ler  o guia oficial do Spring");

        String respondeJson = this.mockMvc.perform(
                post("/tasks")
        ...
        String generatedId = JsonPath.read(respondeJson, "$.id");
        ...
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("$.title").value("Aprender Spring Rest Docs"))
